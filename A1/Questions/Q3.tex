...
\begin{figure}[h]
    ...
    \label{fig:q3-png}
\end{figure}
% a) (5 pts) Derive the equation of motion for this system using the energy method.
% b) (3 pts) Linearize the equation of motion and derive a formula for the natural frequency of the 
% system.
% c) (2 pts) Compare the natural frequency of this system with the case where there is no spring.
